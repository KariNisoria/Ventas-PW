        ...
        <form action="{{route('productos.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="codigo" id="codigo" class="form-control limitar2" value="{{old('codigo')}}">
                    @error('codigo')
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="precio_venta" id="nombprecio_ventare" class="form-control" value="{{old('precio_venta')}}">
                    @error('precio_venta')
                    <small class="text-danger">{{'* '.$message}}</small>
                    @enderror
                </div>
                ...
                <div class="col-12 ">
                    ...
                    <input type="text" name="stock" id="stock" class="form-control limitar" value="{{old('stock')}}">
                    @error('stock')
                    <small class="text-danger">{{'* '.$message}}</small>
                    @enderror
                </div>
